    ...
    return (
        <div className="bg-gray-800 p-6 rounded-lg shadow-md text-white h-full flex flex-col">
            <h3 className="text-xl font-semibold text-[#c0933e] mb-4 flex items-center">
                <Lightbulb size={24} className="mr-3 text-gray-400" /> AI Generated Insights
            </h3>
            ...
            <div className="mb-4 flex flex-wrap items-center gap-4">
                ...
                <div className="flex-shrink-0">
                    <select
                        ...
                        className="p-2 border border-gray-700 rounded-md bg-gray-700 text-white focus:ring-blue-500 focus:border-blue-500"
                    >
                    ...
                    <tbody className="bg-gray-800 divide-y divide-gray-700">
                        {paginatedInsights.length > 0 ? (
                            paginatedInsights.map((insight) => (
                                <tr key={insight.id} className="hover:bg-gray-700 transition-colors duration-200">
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-100 flex items-center">
                                        {getTypeIcon(insight.type)}
                                        {insight.type}
                                    </td>
                                    <td className="px-6 py-4 whitespace-normal font-semibold text-sm text-gray-100">
                                        {insight.title}
                                    </td>
                                    <td className="px-6 py-4 whitespace-normal text-sm text-gray-300 max-w-xs overflow-hidden text-ellipsis">
                                        {insight.description}
                                    </td>
