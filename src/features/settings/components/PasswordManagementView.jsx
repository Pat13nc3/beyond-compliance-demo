...
const PasswordManagementView = ({ onSavePolicy, initialPolicy = {} }) => { // onSavePolicy and initialPolicy from parent
    ...
    const [requireLowercase, setRequireLowercase] = useState(initialPolicy.requireLowercase !== undefined ? initialPolicy.requireLowercase : true);
    ...
    useEffect(() => {
        if (initialPolicy) {
            ...
            setRequireLowercase(initialPolicy.requireLowercase !== undefined ? initialPolicy.lowercase : true); // Fixed typo from 'lowercase' to 'requireLowercase'
    ...
    return (
        <div className="bg-gray-800 p-6 rounded-lg shadow-md text-white space-y-6">
            <h3 className="text-xl font-semibold text-[#c0933e] mb-4">Password Policy Settings</h3>

            {/* Complexity Requirements */}
            <div className="space-y-4">
                <h4 className="text-lg font-medium text-gray-200 flex items-center"><Lock size={18} className="mr-2 text-gray-400" /> Password Complexity</h4>
                <div>
                    <label htmlFor="minLength" className="block text-sm font-medium text-gray-300 mb-2">Minimum Length</label>
                    <input
                        type="number"
                        id="minLength"
                        value={minLength}
                ...
                <div className="grid grid-cols-2 gap-4">
                    <label htmlFor="uppercase" className="flex items-center text-sm text-gray-300">
                    ...
                    <label htmlFor="lowercase" className="flex items-center text-sm text-gray-300">
                    ...
                    <label htmlFor="numbers" className="flex items-center text-sm text-gray-300">
                    ...
                    <label htmlFor="symbols" className="flex items-center text-sm text-gray-300">
            ...
            <div className="space-y-4 pt-4 border-t border-gray-700">
                <h4 className="text-lg font-medium text-gray-200 flex items-center"><Clock size={18} className="mr-2 text-gray-400" /> Expiration Policy</h4>
                <div>
                    <label htmlFor="expirationDays" className="block text-sm font-medium text-gray-300 mb-2">Password Expiration (Days)</label>
                    <input
                        type="number"
                        id="expirationDays"
                        ...
                        className="w-full p-2 border border-gray-700 rounded-md bg-gray-700 text-white focus:ring-blue-500 focus:border-blue-500"
                    />
                    <p className="mt-1 text-xs text-gray-400">Users will be required to change their password after this period.</p>
                </div>
            </div>

            <div className="space-y-4 pt-4 border-t border-gray-700">
                <h4 className="text-lg font-medium text-gray-200 flex items-center"><History size={18} className="mr-2 text-gray-400" /> Password History</h4>
                <div>
                    <label htmlFor="historyCount" className="block text-sm font-medium text-gray-300 mb-2">Remember Last Passwords (Count)</label>
                    <input
                        type="number"
                        id="historyCount"
                        value={historyCount}
                        ...
                        className="w-full p-2 border border-gray-700 rounded-md bg-gray-700 text-white focus:ring-blue-500 focus:border-blue-500"
                    />
                    <p className="mt-1 text-xs text-gray-400">Users cannot reuse their last N passwords.</p>
                </div>
            </div>
