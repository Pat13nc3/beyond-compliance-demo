...
const SystemConfigView = ({ onSaveConfig }) => { // onSaveConfig will be passed from Settings/index.jsx
    ...
    return (
        <div className="theme-bg-card p-6 rounded-lg shadow-md theme-text-primary space-y-6">
            <h3 className="text-xl font-semibold theme-text-highlight-color mb-4">General System Parameters</h3>

            {/* Default Currency */}
            <div>
                <label htmlFor="defaultCurrency" className="block text-sm font-medium theme-text-secondary mb-2">Default Reporting Currency</label>
                <select
                    id="defaultCurrency"
                ...
                <p className="mt-1 text-xs theme-text-secondary">This currency will be used for all financial reporting unless specified otherwise.</p>
            </div>

            {/* Data Retention Period */}
            <div>
                <label htmlFor="dataRetentionDays" className="block text-sm font-medium theme-text-secondary mb-2">Data Retention Period (Days)</label>
                <input
                    type="number"
                    ...
                    className="w-full p-2 border theme-border-color rounded-md theme-bg-card theme-text-primary focus:ring-blue-500 focus:border-blue-500"
                />
                <p className="mt-1 text-xs theme-text-secondary">Data older than this period will be archived or purged.</p>
            </div>

            {/* Audit Log Retention Period */}
            <div>
                <label htmlFor="auditLogRetentionDays" className="block text-sm font-medium theme-text-secondary mb-2">Audit Log Retention Period (Days)</label>
                <input
                    type="number"
                    ...
                    className="w-full p-2 border theme-border-color rounded-md theme-bg-card theme-text-primary focus:ring-blue-500 focus:border-blue-500"
                />
                <p className="mt-1 text-xs theme-text-secondary">Audit trails and user activity logs will be retained for this period.</p>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-gray-100 dark:bg-gray-700 rounded-md">
                <div className="flex items-center">
                    ...
                    <div>
                        <span className="text-sm font-medium theme-text-primary">Enable AI Recommendations</span>
                        <p className="text-xs theme-text-secondary">Allow the system to provide AI-powered insights and task recommendations.</p>
                    </div>
                </div>
